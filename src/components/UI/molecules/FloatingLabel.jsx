    ...
    <>
      <div className="relative z-0 mb-6 w-full group text-sm">
        <input
          ...
          id={id}
          onChange={onChange}
          className="block py-2.5 px-0 w-full text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-sky-400 focus:outline-none focus:ring-0 focus:border-sky-500 peer text-sm"
          placeholder={" "}
          autoComplete="off"
        />
        <label
